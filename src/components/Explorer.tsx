...
const Explorer: React.FC<ExplorerProps> = ({
  ...
  const activeCollectionPreservedData = useMemo(() => {
    ...
    if (selectedYear && (selectedYear > 1964 && selectedYear < 1994)) { 
    ...
    if (selectedYear && (selectedYear >= 1993) && collectionSelection)  {
  ...
  const activeCollection = useMemo(() => {
    ...
    if (selectedYear && (selectedYear > 1964 && selectedYear < 1994)) {
      ...
      if(selectedYear === 1992) { collection =  showBones1992 }
      if(selectedYear === 1993) { collection =  showBones1993 }
